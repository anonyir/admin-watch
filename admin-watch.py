...
async def send_help_message(channel):
	...
	#embedVar.add_field(name=".addwl", value="اضافه کردن کسی به وایت لیست", inline=False)
	#embedVar.add_field(name=".rmwl", value="حذف کردن کسی از وایت لیست", inline=False)
	embedVar.add_field(name=".owners",value="لیست اونر ها",inline=False)
	embedVar.add_field(name=".wl",value="وایت لیست",inline=False)
